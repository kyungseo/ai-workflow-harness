...
`docs/PLAN-SUMMARY.md` Implementation Baseline을 확인해줘. baseline이 비어 있으면 feature 후보 대신 Project Initialization을 첫 P1 후보로 제안하고,
baseline이 완료된 뒤에만 P1-001~ feature 후보를 제안해줘. example pack, role/rule/prompt 정비는 Harness 후보로 분리해줘.
