...
docs/STATUS.md에 Active Work로 올려야 한다면 즉시 수정하지 말고 STATUS Update Proposal로 먼저 보고해줘.
```
...
4. Verification
5. 리스크와 되돌리기 비용
6. docs/STATUS.md 반영 필요 여부
7. DR/TODO/문서 cascade 필요 여부

계획을 보고한 뒤 "진행할까요?"로 끝내고 승인 대기해줘.
STATUS.md 변경은 바로 수행하지 말고 STATUS Update Proposal로 먼저 보고해줘.
```
...
STATUS.md 변경이 필요하면 STATUS Update Proposal을 먼저 보고하고 승인 대기해줘.
...
- docs/STATUS.md (Current State, Active Work, Checkpoints, OQ, Next Actions)
