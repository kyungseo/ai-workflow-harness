...
만약 product backlog가 아직 비어 있으면 먼저 제품 목표, 사용자, Phase 1 범위를 기준으로 초기 작업 후보를 만들 수 있는지 검토해줘 (backlog 후보는 Work ID 없이 제목/slug로 관리하고, Work ID는 /work-plan 착수 승인 시 확정됨).
