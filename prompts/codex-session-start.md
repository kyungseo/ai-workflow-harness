...
5. `docs/BOOTSTRAP.md` — scaffold 직후 프로젝트 부팅 중일 때
...
신규/기존 프로젝트에 하네스를 처음 적용한 직후라면 제품 목표와 Phase 범위를 먼저 정리하고,
그 결과를 `docs/backlog/PHASE1.md`의 Product track 후보로 등록한다.
...
만약 product backlog가 아직 비어 있으면 먼저 제품 목표, 사용자, Phase 1 범위를 기준으로
P1-001~ 후보를 만들 수 있는지 검토해줘.
