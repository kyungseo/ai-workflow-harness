...
현재 저장소에는 Codex 전용 `AGENTS.md`가 없으므로, 이 prompt는 `CLAUDE.md`, `docs/CLAUDE.md`, `docs/STATUS.md`, `docs/HARNESS-PROTOCOL.md`를 Codex가 명시적으로 확인하도록 돕는 fallback이다.
