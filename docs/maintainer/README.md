...
| `ADOPTER-UPGRADE-MIGRATION-PLAYBOOK.md` | 기존 adopter repo를 최신 harness source baseline으로 올릴 때의 temp rehearsal → real apply 반복 절차 |
...
| `HARNESS-TEST-TAXONOMY.md`, `VERIFICATION-COMMANDS.md`, `VERSIONING.md`, `ADOPTER-UPGRADE-MIGRATION-PLAYBOOK.md`, `PRODUCT-STARTER-PLANNING-PACK.md`, `migrations/` | maintainer | source-only (미배포) | `docs/maintainer/` |
