...
| `HARNESS-TEST-TAXONOMY.md`, `VERIFICATION-COMMANDS.md`, `VERSIONING.md`, `PRODUCT-STARTER-PLANNING-PACK.md`, `migrations/` | maintainer | source-only (미배포) | `docs/maintainer/` |
