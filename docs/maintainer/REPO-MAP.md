...
| `~/dev-home/vibe/public-release-playbook` | archived | release playbook의 구 위치 — 2026-07-17 `skillstead` repo `playbooks/public-release/`로 위치 편입(snapshot import), 구 repo는 PRIVATE 유지 + archive |
