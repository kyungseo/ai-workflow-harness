...
| Recent Decisions | **삭제 금지** — 최근 8개 rolling window 유지. 초과분 제거 전 DR-worthy 항목이면 대응 DR 존재 여부 확인. 단순 완료 사실은 Active Work, Checkpoints, commit history에 둔다. 상세 근거는 DR-011. |
