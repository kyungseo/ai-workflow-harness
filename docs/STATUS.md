...
| --- | --- | --- | --- |
| 2026-05-29 | pre-commit hook warning → hard block(exit 1) 전환, commit-msg hook `build` type 추가, 양쪽 모두 설치 | 수개월 manual-first protocol 안정화 후 OQ-2 조건 충족. branch isolation 실질 강제 적용 — CHORE-20260529-003 | Low |
