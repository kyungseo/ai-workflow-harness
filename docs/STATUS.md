...
0. **P0 즉시** — `VERIFICATION-COMMANDS.md` pointer 연결: `docs/AGENT-WORKFLOW.md` Verification Defaults + `skills/workflow/repo-health.md` + `docs/HARNESS-QUICK-REFERENCE.md` pointer 추가, scaffold 포함 여부 확정. (파일 생성·백로그 등록 완료 — 2026-06-08)
...
3. **Archive 대기** — Done Work 24개 누적. 다음 `/session-start` 시 일괄 처리 권장.
