...
| 2026-05-17 | `WORKFLOW-MANUAL.md` 제목·구조 재편 — 'Lightweight Manual-First AI Workflow Harness v1' 명칭 적용, §7 Trigger Reference 본문 승격, Prompt Library·New Project Init·Language Rules를 Appendix A/B/C로 분리, Key Notation 신설 | 사용자 매뉴얼 가독성 개선 및 harness 명칭 통일 | Low |
