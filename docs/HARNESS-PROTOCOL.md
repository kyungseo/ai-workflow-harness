...
Parallel work conflict resolution is a conditional runbook. Load `docs/HARNESS-PARALLEL-WORK-CONTROLS.md` only when Work ID, STATUS/index, DR sequence, command/skill mirror, or scaffold release-timing conflicts appear during parallel branch/agent work.
