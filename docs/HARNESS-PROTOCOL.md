...
| `.claude/commands/*.md` | `AGENTS.md` command index, `.agents/skills/harness-{name}/SKILL.md`, `.cursor/rules/workflow.mdc`, `prompts/*session-start.md`, `docs/HARNESS-QUICK-REFERENCE.md` |
