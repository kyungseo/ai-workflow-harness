...
| `docs/MAINTAINER-GUIDE.md` | HOW, 유지보수 절차 |
...
| 유지보수 절차 | `docs/MAINTAINER-GUIDE.md` |
...
| Project and architecture docs | `docs/PLAN-SUMMARY.md`, `docs/PLAN.md`, `docs/HARNESS-STRUCTURE.md`, `docs/MAINTAINER-GUIDE.md`, `docs/GIT-WORKFLOW.md` | project/harness 구조와 유지보수 지식 |
...
- 유지보수 절차가 바뀌면 `MAINTAINER-GUIDE.md` 업데이트를 제안한다.
...
| T6 | 구조/흐름 구현 변경 | HARNESS-STRUCTURE/MAINTAINER-GUIDE 확인 |
...
| maintainer-facing docs (`README.md`, `MAINTAINER-GUIDE.md`) | 실제 config/script/source와 기술 내용 대조 |
