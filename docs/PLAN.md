...
- `ai-workflow-v1.2.1` patch 릴리즈 — v1.2.0 이후 정합성 복구와 adoption/validation 산출물 후속 보완을 공개 버전으로 확정.
...
| AWH-004 | 진행 | Maintenance & Adoption | 1.2.1 patch 릴리즈, 실 adopter upgrade/migration, onboarding/manual 현행화, 운영 부채 축소. 후보는 `docs/backlog/HARNESS.md` |
