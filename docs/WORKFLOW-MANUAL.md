...
현재 9개: `start`, `pick`, `register`, `work`, `resume`, `debug`, `done`, `record-decision`, `health`
...
- [ ] **`.claude/commands/`** 파일 9개 복사 및 프로젝트 Phase명·backlog 경로 조정
  - `start.md`, `pick.md`, `register.md`, `work.md`, `resume.md`, `debug.md`, `done.md`, `record-decision.md`, `health.md`
