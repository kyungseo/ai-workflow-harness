...
- `.claude/commands/{name}.md` / `.agents/skills/workflow-{name}/SKILL.md` / `.cursor/rules/workflow.mdc` — Claude/Codex/Cursor adapter. 12개 command 목록과 용도는 [§5 Slash Commands Reference](#5-slash-commands-reference) 참조.
