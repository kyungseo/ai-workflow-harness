...
CI는 `develop` push에서 build job을 실행하고, `main` push 또는 `main` 대상 PR에서 `lint → test` 순서로 실행된다 (`.github/workflows/ci.yml`).
...
브랜치 전략·PR 흐름·post-PR 절차·CI 연동 상세: [`docs/GIT-WORKFLOW.md`](GIT-WORKFLOW.md)
