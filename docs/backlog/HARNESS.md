...
| HRN-034 | P1 | Candidate | L2 | Scaffold Product Definition / Project Initialization Gate — 기능 구현 전 product 결정과 초기화 계획 구체화 | HRN-033 이후 scaffold onboarding 보완 | scaffold 직후 example feature를 바로 구현하지 않고 Product Definition, Project Initialization, PLAN/PLAN-SUMMARY baseline을 먼저 확정하도록 bootstrap/source/prompt surface를 정렬 | generic/spring-boot scaffold 시뮬레이션, generated BOOTSTRAP/PLAN/PLAN-SUMMARY/PHASE1 guard 확인, PoC/MVP 초기화 흐름 문서 기준 검증 |
