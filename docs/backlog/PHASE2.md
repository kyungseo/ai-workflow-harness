...
| PRE-C1 | P0 | Candidate | Phase 1 아키텍처 현황 분석 (레이어 일관성, common-core, gateway, 테스트 커버리지) | Phase1 implementation | 분석 결과와 개선 필요 항목 목록 작성 | backlog 또는 planning 문서 반영 확인 |
...
> Phase2 본격 착수 전에는 `Phase 2 Preparation Candidates`를 먼저 검토한다.
