...
- [ ] Current surface inventory 작성
- [ ] Source-only / target-runtime / optional-reference 분류표 작성
- [ ] End-to-end workflow diagram 초안 작성
- [ ] Gate inventory와 계층화 초안 작성
- [ ] PLAN / Phase / Work / Backlog / DR lifecycle 재설계안 작성
- [ ] Scaffold pack 전략과 default output 축소안 작성
- [ ] Scaffold 후 onboarding process 재설계안 작성
- [ ] AI tool surface responsibility matrix 작성
- [ ] settings/hooks/CI/test 개선 후보 작성
- [ ] Git/open/public release 참조 경계 정리 (`public-release-playbook` reference 포함)
- [ ] 제거/보강/유지/optional 이동 후보 목록 작성
- [ ] Phase 2 execution roadmap 작성
- [ ] DR-worthy decision 후보 목록 작성
- [ ] Claude review 반영
- [ ] Codex/Claude 합의 또는 unresolved question 기록
