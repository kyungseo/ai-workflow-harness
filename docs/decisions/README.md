...
| DR-031 | Product Track Structure — Symmetric PRODUCT.md + Optional Phase | 2026-06-09 | Accepted | harness | product backlog/work를 harness와 대칭(`PRODUCT.md`/`works/product/`)으로, phase는 optional migration. PHASE{n} 네이밍 충돌 해소 |
