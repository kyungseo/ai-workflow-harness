...
|----|-------|------|--------|-------|------|
| DR-007 | 파일 유형별 작성 언어 원칙 | 2026-05-11 | Accepted (Amended) | harness | 언어 정책 단일 SSoT. 파일 유형 + commit/PR + agent 출력(behavioral) + default/단일 override 지점. 다른 표면은 재서술 없이 pointer (2026-06-15 amend) |
