...
- **Candidate**: 기본적으로 `docs/backlog/` 에 존재하는 후보. 큰 작업은 착수 전 `docs/works/{category}/`에 Candidate Work 파일 초안을 가질 수 있음.
...
권장 섹션 구조는 `docs/harness-protocol/03-work-items-and-naming.md` Index Rules를 따른다.

권장 섹션: Candidate / Active / Done (archive pending) / Archived
...
- `docs/backlog/` 의 항목은 Candidate pool이며, 큰 작업은 착수 전 Candidate Work 파일 초안을 가질 수 있다.
