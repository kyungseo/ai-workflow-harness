...
| `docs/works/product/` | Product track 작업 (product-track FEAT-*/PATCH-*/HOTFIX-*; historical: P{n}-*, PRE-*). 단계 운영 여부와 무관하게 단일 디렉토리 |
...
권장 섹션(live README): Active / Done (Archive Pending). Archived 인덱스는 hot-path live README에 누적하지 않고 archive-side `docs/archive/docs/works/{category}/README.md`에 둔다.
...
| 2026-06-13 | live README 권장 섹션을 Active / Done (Archive Pending)로 조정. Archived 인덱스는 archive-side README로 이전 |
