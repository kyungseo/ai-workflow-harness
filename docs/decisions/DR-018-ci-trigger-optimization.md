...
- DR-009 (부분 — develop push Checkstyle trigger 제거)
...
- feature→develop PR에서는 CI 미실행 → Java/Gradle 변경은 PR 전 로컬 검증 결과를 확인하고, 최종 CI 검증 책임은 develop→main PR로 집중
...
- DR-009: CI trigger 분리 전략 (develop push Checkstyle 정책 superseded)
