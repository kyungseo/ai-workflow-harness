---
description: "전략/비교/포지션 brief를 작성하거나 retrospective/decision과의 분류를 정리한다"
argument-hint: "[topic-or-document]"
disable-model-invocation: true
---

# /work-brief

이 파일은 Claude Code slash command adapter다. 상세 절차의 SSoT는 `skills/workflow/work-brief.md`다.
...
Claude Code에서 `/work-brief` slash command로 호출된다. 전달된 인자는 canonical 절차의 `$ARGUMENTS`로 해석한다.
