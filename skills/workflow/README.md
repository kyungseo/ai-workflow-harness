...
| `/repo-decision` | `skills/workflow/repo-decision.md` | `.claude/commands/repo-decision.md` | `.agents/skills/workflow-repo-decision/SKILL.md` | 확정된 기술적 의사결정을 DR 파일로 기록한다 |
