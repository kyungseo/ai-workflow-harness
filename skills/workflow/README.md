...
| `/work-brief` | `skills/workflow/work-brief.md` | `.claude/commands/work-brief.md` | `.agents/skills/workflow-work-brief/SKILL.md` | 전략·비교·포지션 brief를 작성하거나 retrospective/decision과의 문서 분류를 정리한다 |
| `/cross-review` | `skills/workflow/cross-review.md` | `.claude/commands/cross-review.md` | `.agents/skills/workflow-cross-review/SKILL.md` | 선택적 cross-agent review relay. driver/reviewer 역할, round packet, findings, driver response, user decision gate를 표준화한다 |
