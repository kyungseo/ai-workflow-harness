...
5. \`docs/backlog/PHASE1.md\` — baseline 완료 후 도출한 초기 작업 항목 \`P1-001~\`
...
4. Implementation Baseline 완료 후 \`docs/backlog/PHASE1.md\`에 P1-001~ 후보 등록
...
- [ ] \`docs/backlog/PHASE1.md\` Active Candidates에 P1-001~ 후보 등록
...
> code development가 필요한 프로젝트: 첫 후보는 \`P1-001 Project Initialization\`.
...
echo "  docs/backlog/PHASE1.md — baseline 완료 후 도출한 초기 작업 항목 P1-001~"
